...
import UIKit
class HomeDiscountCourseCell: EOBaseTableViewCell {
    ...
    static func reuseIdentifier() -> String {
        return "HomeDiscountCourseCell"
    }
}

extension HomeDiscountCourseCell: ZCycleViewProtocol {

...
- (void)layoutSubviews {
    ...
    self.textLabel.frame = CGRectMake(40, 16, 200, self.textLabel.font.lineHeight);
}
...
- (instancetype)initWithDelegate:(id<YBPopupMenuDelegate>)delegate titles:(NSArray<NSString *> *)titles icons:(NSArray<UIImage *> *)icons itemWidth:(CGFloat)itemWidth
{
    if (self = [super init]) {
        [self setDefaultSettings];
...
- (void)setDefaultSettings
{
    ...
    _menuBackView.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.6f];

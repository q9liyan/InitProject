...
@interface LEEEOBaseViewController : UIViewController @end

@interface LEEAlertViewController : LEEEOBaseViewController @end

@interface LEEActionSheetViewController : LEEEOBaseViewController @end

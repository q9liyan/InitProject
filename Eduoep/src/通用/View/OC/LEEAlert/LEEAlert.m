...
@property (nonatomic , strong ) LEEEOBaseViewController *viewController;
...
@interface LEEEOBaseViewController ()<UIGestureRecognizerDelegate>
...
@implementation LEEEOBaseViewController
